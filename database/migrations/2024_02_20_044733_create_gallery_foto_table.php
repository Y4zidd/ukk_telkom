...

{
    ...
    public function up()
    {
        Schema::create('gallery_foto', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('album_id'); // Gunakan tipe yang sama dengan 'album_id' di 'albums'
            $table->foreign('album_id')->references('album_id')->on('albums')->onDelete('cascade'); // Membuat foreign key 'album_id' yang merujuk ke tabel 'albums'
